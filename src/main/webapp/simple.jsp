    ...
    <c:forEach var="product" items="${products}">
        <div class="container">
            ...
            <span class="pull-right">
                ...
                <button data-placement="right" data-trigger="manual"
        ...
        if(qty== ""){ // the user didn't specify a quantity
            ...
            $.ajax({
                ...
                success: function(data, status){
                    ...
                    popstr = 'Item'+(qty>1? 's' : '') + ' added to cart!';
                    $('#btn'+id).popover({content: popstr,
                        placement:"right",
                        trigger: "manual"});
                    $('#btn'+id).popover('show');
                }
